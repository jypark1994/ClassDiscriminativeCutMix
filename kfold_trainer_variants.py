...
def train_k_fold_MACM(model, train_loader, optimizer, scheduler, criterion, num_folds, cur_epoch, device, **kwargs):
    """
        ...
        train_k_fold_MACM - Training Multiscale Activation CutMix using K-fold cross validation.
        * Where target stage is the final, it's equivalent to Attentive CutMix (Walawalka et al, 2020). 
