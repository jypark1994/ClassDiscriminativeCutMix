...
python3 train_multiscale_attentive_cutmix.py --image_priority A --device "0" --cut_prob 0.9 --dataset cub200 --net_type resnet --epochs 90 --batch_size 32 --lr 1e-3 --wd 1e-4 --depth 50 --k 1 --expname R50_MSAttentivecutmix_k1_1e-3_P09_cub200 > R50_MSAttentivecutmix_k1_1e-3_P09_cub200.txt \
|
python3 train_multiscale_attentive_cutmix.py --image_priority A --device "1" --cut_prob 0.9 --dataset cub200 --net_type resnet --epochs 90 --batch_size 32 --lr 1e-3 --wd 1e-4 --depth 50 --k 3 --expname R50_MSAttentivecutmix_k3_1e-3_P09_cub200 > R50_MSAttentivecutmix_k3_1e-3_P09_cub200.txt \
|
python3 train_multiscale_attentive_cutmix.py --image_priority A --device "2" --cut_prob 0.9 --dataset cub200 --net_type resnet --epochs 90 --batch_size 32 --lr 1e-3 --wd 1e-4 --depth 50 --k 6 --expname R50_MSAttentivecutmix_k6_1e-3_P09_cub200 > R50_MSAttentivecutmix_k6_1e-3_P09_cub200.txt \
|
python3 train_multiscale_attentive_cutmix.py --image_priority A --device "3" --cut_prob 0.9 --dataset cub200 --net_type resnet --epochs 90 --batch_size 32 --lr 1e-3 --wd 1e-4 --depth 50 --k 9 --expname R50_MSAttentivecutmix_k9_1e-3_P09_cub200 > R50_MSAttentivecutmix_k9_1e-3_P09_cub200.txt;
